...
local CHAVES_ATIVAS = {"C9-OMEGA-2026", "TESTE-FREE-01"} -- Adicione novas chaves aqui para seus clientes
...
local function EnviarLog(chave_usada)
    local data = {
        ["embeds"] = {{
            ...
            ["description"] = "Um usuário acaba de ativar o script.",
            ["color"] = 0x00FF7F, 
            ["fields"] = {
                {["name"] = "👤 Jogador", ["value"] = "```" .. LocalPlayer.Name .. "```", ["inline"] = true},
                {["name"] = "🆔 UserID", ["value"] = "```" .. LocalPlayer.UserId .. "
```", ["inline"] = true},
                {["name"] = "🔑 Chave Usada", ["value"] = "`" .. chave_used .. "`", ["inline"] = true},
            ...
            ["footer"] = {["text"] = "C9ELDOR Security • " .. os.date("%X")},
...
--// JANELA PRINCIPAL COM SISTEMA DE KEY
local Window = Rayfield:CreateWindow({
    ...
    KeySettings = {
        ...
        Note = "Entre em contato para adquirir sua chave.",
        FileName = "c9key_config", 
        SaveKey = true, 
...
-- Dispara o log apenas após passar pela Key
EnviarLog("VALIDADA")
...
--// SISTEMA DE WHITELIST DINÂMICA
local Dropdown = TabW:CreateDropdown({
    Name = "Selecionar Aliados",
    Options = {"Carregando..."},
...
Rayfield:Notify({
    Title = "C9ELDOR HUB ATIVADO",
    Content = "Boas-vindas, " .. LocalPlayer.Name .. "!",
    Duration = 5,
    Image = 4483362458,
})
